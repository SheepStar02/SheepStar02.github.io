...
class Projects extends React.Component {
    ...
    render () {
        const PROJECTS = JSON.parse(
            '[{"title":"Gaming Website { Monopoly }","images":["monopoly-slideshow-1","monopoly-slideshow-2","monopoly-slideshow-3","monopoly-slideshow-4","monopoly-slideshow-5","monopoly-slideshow-6"],"content":"This has been a project I worked on for almost 8 months and I am very proud for how it has turned out. Using only the basic javascript HTML and CSS, I recreated the classic game of monopoly along with a login system and the potential for new games to be added.","addition":"In addition to the front-end languages, I used firebase as my database for the login system and Websockets to host the server for running the game. Since Github pages only supported static webpages, I hosted my server on Heroku while keeping the website on my github pages. As I kept working on my project, I felt myself improve thoughout the entire journey and this is evident on the final product at the designs created were much simpler in the main website compared to the game. Although this project is not completely finished and I plan on continuing to improve the user experience, I believe this project accuratly represents my skills and capabilities as a front-end developer","src":["https://sheepstar02.github.io","https://github.com/sheepStar02/sheepStar02.github.io"]},' +
            '{"title":"Image Uploader","images":["imup-slideshow-1","imup-slideshow-2","imup-slideshow-3"],"content":"Although a much smaller project, I felt the need to include this because it demonstrates collaboration skills and my abilities to make simple yet effective designs. This project was made to introduce a friend of mine to front-end development and is inspired by image uploading websites such as imgur.","addition":"The website uses firebase to store uploaded images. A server was created using the Express library and I learned a lot about back-end development through this project. The website uses vanilla HTML, CSS and Javascript with more simplistic designs and methods to make the learning experience more enjoyable. Although my skills are far beyond this project, I thought it would be important to demonstrate my collaboration skills rather than pure coding techniques.","src":["https://github.com/sheepStar02/imageuploader","https://github.com/sheepStar02/imageuploader"]},' +
            '{"title":"Jumble Type","images":["jumbletype-slideshow-1","jumbletype-slideshow-2","jumbletype-slideshow-3","jumbletype-slideshow-4","jumbletype-slideshow-5"],"content":"A small but interesting project where I wanted to create something fun and exciting within the shortest time possible. Using React, I built a memory/typing game with a refreshing daily challenge similar to wordle in just 2 days.","addition":"Many of the modern React techniques such as hooks, state and refs were used in this project. The game also creates a new set of words each day (2pm EST) that everyone shares across the world. The freeplay mode also allows players to practice and improve their memory with random common english words. I learned quite a bit through this project and also tested my abilities to work quickly and efficiently but also keeping the same attention to details such as the dark mode feature and these preferences are saved even when the player exits the webpage!","src":["https://sheepstar02.github.io/jumbletype","https://github.com/sheepStar02/sheepStar02.github.io"]},' +
            '{"title":"Sudoku Solver","images":["sudoku-slideshow-1","sudoku-slideshow-2","sudoku-slideshow-3","sudoku-slideshow-4","sudoku-slideshow-5"],"content":"One of the more interesting and alogrithm related projects. The sodoku solver features a very visual approach to understand the alogrithm behind the game of sudoku.","addition":"As I became more confortable using react, I tried adding some more complexity within this project. Using more react hooks and complex recursive functions, this became one of the most challenging projects. The main theme of the project was clear, optimizing the sudoku solver was the most important aspect of this solver. Although the solver is quite sophisticated in solving known puzzles, there are still struggles trying to calculate puzzles that have no solution or take an incredible amoung of predictions to solve. Regardless, this was one of the most complex and interesting projects and I had a ton of fun completing, and learning about sudoku solvers.","src":["https://sheepstar02.github.io/sudoku","https://github.com/sheepStar02/sheepStar02.github.io"]}]'
        );
