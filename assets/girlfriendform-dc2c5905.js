import{r as ye,j,F as lc,a as R,c as hc,R as dc}from"./client-a4c3e432.js";/* empty css              */const fc=[{name:"Morning routine",options:[{label:"Brushed teeth",value:"brushed-teeth"},{label:"Washed face",value:"washed-face"},{label:"Hair and makeup",value:"hair-and-makeup"},{label:"Ate breakfast",value:"ate-breakfast"},{label:"Maintained clean room",value:"maintained-clean-room"}]},{name:"Exercises",options:[{label:"Recovery",condition:[3,6],value:"recovery"},{label:"Took a walk",condition:[3,6],value:"took-a-walk"},{label:"Cardio (15 mins)",condition:[1,4],value:"cardio-(15-mins)"},{label:"Core (15 mins)",condition:[5],value:"core-(15-mins)"},{label:"Bridges",condition:[2],value:"bridges"},{label:"Seated ball",condition:[2],value:"seated-ball"},{label:"Straight leg raises",condition:[2],value:"straight-leg-raises"},{label:"Side lying straight leg raises",condition:[2],value:"side-lying-straight-leg-raises"},{label:"Leg presses inward",condition:[2],value:"leg-presses-inward"},{label:"Clam shells",condition:[2],value:"clam-shells"},{label:"Plank hold",condition:[2],value:"plank-hold"},{label:"Side plank hold",condition:[2],value:"side-plank-hold"},{label:"Pilates hold",condition:[2],value:"pilates-hold"},{label:"Wall sit",condition:[2],value:"wall-sit"}],condition:[1,2,3,4,5,6]},{name:"POTS",options:[{label:"3+ grams of salt",value:"3+-grams-of-salt"},{label:"2+ litres of water",value:"2+-litres-of-water"},{label:"8+ hours of sleep",value:"8+-hours-of-sleep"},{label:"In bed before 11pm",value:"in-bed-before-11pm"},{label:"Wore compression clothes",value:"wore-compression-clothes"}]},{name:"Night time routine",options:[{label:"Brushed teeth",value:"brushed-teeth"},{label:"Washed face",value:"washed-face"},{label:"Shower",value:"shower"},{label:"Journaling",value:"journaling"}]}],pc=[{type:"scale",question:"How did you sleep?",start:1,end:5,startText:"Shit",endText:"Amazing",id:"msc-sleep"},{type:"scale",question:"How do you think today will go?",start:1,end:5,startText:"Shit",endText:"Incredible",id:"msc-today"},{type:"scale",question:"How busy are you today?",start:1,end:5,startText:"Gaming",endText:"Ignore me",id:"msc-busy"},{type:"checklist",question:"How do you feel?",options:[{label:"Anxious",value:"anxious"},{label:"Stressed",value:"stressed"},{label:"Upset",value:"upset"},{label:"Happy",value:"happy"},{label:"Sad",value:"sad"},{label:"Guilty",value:"guilty"},{label:"Angry",value:"angry"},{label:"Scared",value:"scared"},{label:"Eepy",value:"eepy"},{label:"Tired",value:"tired"},{label:"Silly",value:"silly"},{label:"Affectionate",value:"affectionate"},{label:"Worried",value:"worried"},{label:"Excited",value:"excited"}],id:"mmc-feel"},{type:"radio",question:"Do you love me? ❤️",options:[{label:"Yes",value:"yes-1"},{label:"Yes",value:"yes-2"}],id:"mmr-love"},{type:"text",question:"What's something you're looking forward to today?",id:"mla-forward"},{type:"text",question:"What did you dream about?",id:"mla-dream"},{type:"text",question:"What's something you'd like to achieve today?",id:"mla-achieve"}],gc=[{type:"scale",question:"How did today go?",start:1,end:5,startText:"Shit",endText:"Amazing",id:"nsc-today"},{type:"checklist",question:"How do you feel?",options:[{label:"Anxious",value:"anxious"},{label:"Stressed",value:"stressed"},{label:"Upset",value:"upset"},{label:"Happy",value:"happy"},{label:"Sad",value:"sad"},{label:"Guilty",value:"guilty"},{label:"Angry",value:"angry"},{label:"Scared",value:"scared"},{label:"Eepy",value:"eepy"},{label:"Tired",value:"tired"},{label:"Silly",value:"silly"},{label:"Affectionate",value:"affectionate"},{label:"Worried",value:"worried"},{label:"Excited",value:"excited"}],id:"nmc-feel"},{type:"radio",question:"Do you love me? ❤️",options:[{label:"Yes",value:"yes-1"},{label:"Yes",value:"yes-2"}],id:"nmr-love"},{type:"text",question:"Tell me about your day",id:"nla-day"},{type:"text",question:"What's something on your mind right now?",id:"nla-mind"}];/**
 * @license
